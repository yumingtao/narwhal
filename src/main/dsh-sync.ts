 ...
 * to low/medium/high; the field is only sent when an effort is actually
 * selected for the session, so gateways that ignore the parameter are
 * unaffected.
 */
const DEFAULT_OPENAI_REASONING_LEVELS = ['low', 'medium', 'high'] as const
